        ...
        <div className="font-sniglet overflow-hidden text-black-100">
            ...
            <div className="lg:px-20 px-5 bg-top">
                <div className='container mx-auto'>
                    ...
                    <div className="lg:flex block justify-center items-start pb-12 lg:space-y-0 space-y-6">
                        ...
                        <div className=''>
                            ...
                            <div className='md:my-16 my-8 lg:flex items-start justify-between lg:space-y-0 space-y-8'>
                                ...
                                <div data-aos="fade-in" className='lg:w-1/2 w-full'>
                                    <iframe title='wallet' src="https://jup.ag/swap/SOL-USDC" height="670" className=' rounded-xl border-4 border-white-100 flex mx-auto lg:w-8/12 w-full'></iframe>
                                </div>
                            </div>
